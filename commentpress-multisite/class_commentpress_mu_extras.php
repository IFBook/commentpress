	...
	*/
	...
	function add_admin_menu() {
		...
		$page = add_submenu_page( 
			...
			'bp-general-settings', 
			__( 'Commentpress Multisite Extras Setup', 'commentpress-plugin' ), 
			__( 'Commentpress Multisite Extras Setup', 'commentpress-plugin' ), 
			'manage_options', 
			'cpmsextras_admin_page', 
	...
	function add_admin_styles() {
		...
		// add css
		wp_enqueue_style('cpmsextras-admin-style', CP_PLUGIN_URL . 'assets/css/admin.css');
		
		// add javascripts
		wp_enqueue_script( 'cpmsextras-admin-js', CP_PLUGIN_URL . 'assets/js/admin.js' );
		*/
...
<h2>Commentpress for Multisite Extras Settings</h2>

<form method="post" action="'.htmlentities($url.'&updated=true').'">

'.wp_nonce_field( 'cpmsextras_admin_action', 'cpmsextras_nonce', true, false ).'
...
<p class="submit">
	<input type="submit" name="cpmsextras_submit" value="Save Changes" class="button-primary" />
</p>
	...
	*/
	...
	function _register_hooks() {
		...
		if ( is_admin() ) {
			...
			// add menu to BuddyPress submenu (don't need this)
